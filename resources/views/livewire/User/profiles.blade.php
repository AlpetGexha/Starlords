    <x-card>
        <div>
            ...
            <div class="mt-1 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6" x-data="{
                my_email: '{{ auth()->user()->email }}',
                email: '',
            }">
                <div class="sm:col-span-4">
                    <x-input wire:model.defer='name' label="Organization Name" placeholder="Organization Name"
                        class="pl-9">
                        <x-slot name="prepend">
                            <div
                ...
                <div class="sm:col-span-4">
                    <x-input wire:model.defer='email' x-model='email' icon="inbox" label="Email"
                        placeholder="Email" />
                    <button x-on:click='email = my_email' class="text-sm text-gray-500 transition-colors">
                        Use my Email
                    </button>
                </div>

                <div class="sm:col-span-4">
                    <x-inputs.maskable icon="phone" label="Telxephone" placeholder="+383 12 123 456"
                        mask="['+(###) ## ###-###', '+# ### ###-####', '+## ## ####-####']" wire:model.defer='number' />
                </div>

                <div class="sm:col-span-4">
                    <x-input wire:model.defer='website' icon="link" label="Website"
                        placeholder="wwww.your-domain.com" />
                </div>
                ...
                <div class="sm:col-span-4">
                    <x-select multiselect wire:model.defer='categorys' label="Categorys"
                        placeholder="Select some status">
        ...
        <x-slot name="footer">
            <x-buttonn wire:click.prevent='create()' type="submit"
